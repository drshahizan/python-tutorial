...
| 4.   | Python for Data Analysis with Google Colab |<a href="https://medium.com/@ivannfalah/exercise-2-python-for-data-analysis-with-google-colab-b3df60f4d3b6" ><img src="./images/python.png" width="24px" height="24px" ></a> ||
| 5.   | Charts: visualising data | <a href="https://colab.research.google.com/notebooks/charts.ipynb" ><img src="./images/python.png" width="24px" height="24px" ></a> |

### 3. Lab
| No. | Content                                             | File |
|----: |----------------------------------------------------|------|
| 1.   | Python Tutorial With Google Colab    | <a href="./basic/Lab1_Colab_tutorial.ipynb" ><img src="./images/python.png" width="24px" height="24px" ></a> |
| 2.   | Mounting    | <a href="./basic/Lab2_Mounting_and_Magics.ipynb" ><img src="./images/python.png" width="24px" height="24px" ></a> |
| 3.   | ML in Cybersecurity: Tutorial I    | <a href="./basic/Lab3.ipynb" ><img src="./images/python.png" width="24px" height="24px" ></a> |
| 4.   | Intro to Modeling    | <a href="./basic/lab4_Intro_to_modeling.ipynb" ><img src="./images/python.png" width="24px" height="24px" ></a> |
